package com.tariq.animeheroes.utils

object Constants {

    //const val LOCAL_BASE_URL = "http://10.0.2.2:8080" //for emulator
    const val LOCAL_BASE_URL = "http://192.168.100.33:8080"
    ...
    const val DATABASE_NAME = "anime_hero_database"
    const val ON_BOARDING_PAGE_COUNT = 3
    const val LAST_ON_BOARDING_PAGE = 2
    const val DATASTORE_NAME = "anime_datastore"
